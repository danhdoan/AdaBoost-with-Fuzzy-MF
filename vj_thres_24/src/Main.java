...
public class Main {
    ...
    public final static String pathWeakClass = pathOutput + File.separator + "weakclass"
            + File.separator + "20180126_vj_24.wk";
    ...
    public static int numFeature = 356456; // SizeOfFeature
    ...
    public static void main(String[] args) {
        ...
        //analyzeProcess();
        testingProcess(pathTest, pathTestInfo, 0.25, 0.8);
    }
    ...
    public static void testingProcess(String pathImg, String pathInfo, double low, double high) {
        ...
        double rate = low;
        while (rate <= high) {
            testData_threshold(pathInfo, rate);
            rate += 0.01;
        }
    }
