 ...
 *      also uses Fuzzy logic with Gaussian MF
...
public class Main {
    ...
    public final static String pathWeakClass = pathOutput + File.separator + "weakclass"
            + File.separator + "20180125_fuzzy_gauss2_24.wk";
    ...
    public static void main(String[] args) {
        ...
        testingProcess(pathTest, pathTestInfo, 0.36, 0.7);
    }
    ...
    public static Boolean isPositiveDist(double meanPos, double varPos, double meanNeg, double varNeg,
        ...
        double temp1 = 2 * (val - meanPos) * (val - meanPos) / (gamma * varPos);
        double temp2 = 2 * (val - meanNeg) * (val - meanNeg) / (gamma * varNeg);

        double left = Math.log(varNeg / varPos);
        double right = temp1 - temp2;
